...
export class MockedSnapshot extends Snapshot {
    ...
    forEach(callback) {
        ...
        if (this._data instanceof Array) {
            for (let object of this._data) {
                callback(new MockedSnapshot(object, this._dataSource));
            }
        }
        else if (this._data instanceof Object) {
            for (let key in this._data) {
                callback(new MockedSnapshot(object, this._dataSource, { key: key, value: this._data[key] }));
            }
        }
    }

...
System.register("components/RequestClient", [], function($__export) {
  ...
  function PostRequest(options) {
    ...
    return new Promise((function(resolve, reject) {
      ...
      for (var $__0 = options.headers.entries()[$traceurRuntime.toProperty(Symbol.iterator)](),
  ...
  return {
    ...
    execute: function() {
      $__export('default', (function($__super) {
        var SharePointSnapshot = function SharePointSnapshot(dataSnapshot) {
        ...
        return ($traceurRuntime.createClass)(SharePointSnapshot, {
          ...
          forEach: function(callback) {
            if (this._data instanceof Array) {
              for (var $__1 = this._data[$traceurRuntime.toProperty(Symbol.iterator)](),
                  $__2 = void 0; !($__2 = $__1.next()).done; ) {
...
System.register("datasources/SharePoint/SoapClient", ["datasources/SharePoint/xml2js", "npm:lodash@3.7.0", "components/RequestClient", "utils/objectHelper", "components/XmlParser"], function($__export) {
  ...
  return {
    ...
    execute: function() {
      SoapClient = $__export("SoapClient", (function() {
        var SoapClient = function SoapClient() {
          ObjectHelper.bindAllMethods(this, this);
...
System.register("core/Model/prioritisedObject", ["npm:lodash@3.7.0", "npm:eventemitter3@1.1.0", "utils/objectHelper", "core/Model/snapshot"], function($__export) {
  "use strict";
...
System.register("datasources/SharePointSoapDataSource", ["utils/objectHelper", "core/DataSource", "github:firebase/firebase-bower@2.2.4", "github:angular/di.js@master", "datasources/SharePoint/SoapClient", "components/UrlParser", "datasources/SharePoint/SharePointSnapshot"], function($__export) {
  ...
  return {
    ...
    execute: function() {
      SharePointSoapDataSource = $__export("SharePointSoapDataSource", (function($__super) {
        var SharePointSoapDataSource = function SharePointSoapDataSource(path, credentials) {
        ...
        return ($traceurRuntime.createClass)(SharePointSoapDataSource, {
          ...
          set: function(newData) {
            ...
            for (var prop = void 0 in newData) {
            ...
            this._dataReference.call(configuration).then((function(result) {
              for (var $__2 = result[$traceurRuntime.toProperty(Symbol.iterator)](),
                  $__3 = void 0; !($__3 = $__2.next()).done; ) {
                var data = $__3.value;
                {
                  var snapshot = new SharePointSnapshot(data, $__0);
